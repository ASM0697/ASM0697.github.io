...
<div class="portfolio-container">
  <div id="portfolioGrid" class="portfolio-grid">
    ...
    <div class="sci-card" onclick="openSciModal(0)" role="button" tabindex="0" aria-label="View Metabolic Disorders, Autonomic Immune Dysfunction, and Ferroptosis">
      ...
      <div class="sci-card-body">
        ...
        <div class="sci-card-footer">
          <span class="sci-card-tag">Illustrations</span>
    ...
    <!-- Card 4 -->
    <div class="sci-card" onclick="openSciModal(3)" role="button" tabindex="0" aria-label="View Autonomic Nervous System & Vagal Tone">
      <div class="sci-card-img-wrapper">
        <img src="autonomic-dysregulation.png" alt="Autonomic Nervous System & Vagal Tone" loading="lazy" />
        <div class="sci-card-hover-overlay">
          <span class="sci-preview-badge">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <circle cx="11" cy="11" r="8"></circle>
      ...
      <div class="sci-card-body">
        <div class="sci-card-top-bar">
          <span class="sci-card-fig-num">FIG 04</span>
          <span class="sci-card-date">June 2025</span>
        </div>
        <h3 class="sci-card-title">Autonomic Nervous System & Vagal Tone</h3>
        <p class="sci-card-desc">Neuro-immune axis highlighting sympathetic hyperreactivity and vagal anti-inflammatory pathway impairment in systemic metabolic dysfunction.</p>
        <div class="sci-card-footer">
          <span class="sci-card-tag">Illustrations</span>
          <span class="sci-card-action">View Figure <span class="sci-arrow">&rarr;</span></span>
        </div>
